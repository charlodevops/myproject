#Create a user check on IDC before adding permissions to an account.
#The user validation has been added
#Now there is a user check in the lambda function. So only the users who are assigned the OKTA app will be given permissions
